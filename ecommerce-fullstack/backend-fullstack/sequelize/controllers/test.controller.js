...
const SequelizeTest = db.sequelizetest;
...
exports.findAll = (req, res) => {
    ...
    .catch(err => {
      res.status(500).send({
        message:
          err.message || "Some error occurred while getting the Tests."
      });
    });
